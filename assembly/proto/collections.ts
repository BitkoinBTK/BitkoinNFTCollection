...
export namespace collections {
  ...
  export class token_object {
    static encode(message: token_object, writer: Writer): void {
      ...
      if (message.bitkoin_value != 0) {
        writer.uint32(16);
        writer.uint64(message.bitkoin_value);
      }

      if (message.bought != false) {
        writer.uint32(24);
        writer.bool(message.bought);
      }

      if (message.boughtBy.length != 0) {
        writer.uint32(34);
        writer.bytes(message.boughtBy);
      }
    ...
    static decode(reader: Reader, length: i32): token_object {
      ...
      while (reader.ptr < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2:
            message.bitkoin_value = reader.uint64();
            break;
    ...
    constructor(
      ...
      bitkoin_value: u64 = 0,
      bought: bool = false,
      boughtBy: Uint8Array = new Uint8Array(0),
      claimed: bool = false
    ) {
      this.owner = owner;
      this.bitkoin_value = bitkoin_value;
      this.bought = bought;
  ...
  export class get_bought_by_arguments {
    static encode(message: get_bought_by_arguments, writer: Writer): void {
      if (message.token_id.length != 0) {
        writer.uint32(10);
        writer.bytes(message.token_id);
      }
    ...
    static decode(reader: Reader, length: i32): get_bought_by_arguments {
      const end: usize = length < 0 ? reader.end : reader.ptr + length;
      const message = new get_bought_by_arguments();
  ...
  export class bitkoin_value_of_arguments {
    static encode(message: bitkoin_value_of_arguments, writer: Writer): void {
      if (message.token_id.length != 0) {
        writer.uint32(10);
        writer.bytes(message.token_id);
      }
    ...
    static decode(reader: Reader, length: i32): bitkoin_value_of_arguments {
      const end: usize = length < 0 ? reader.end : reader.ptr + length;
      const message = new bitkoin_value_of_arguments();
  ...
  export class is_bought_arguments {
    static encode(message: is_bought_arguments, writer: Writer): void {
      if (message.token_id.length != 0) {
        writer.uint32(10);
        writer.bytes(message.token_id);
      }
    ...
    static decode(reader: Reader, length: i32): is_bought_arguments {
      const end: usize = length < 0 ? reader.end : reader.ptr + length;
      const message = new is_bought_arguments();
  ...
  export class is_claimed_arguments {
    static encode(message: is_claimed_arguments, writer: Writer): void {
      if (message.token_id.length != 0) {
        writer.uint32(10);
        writer.bytes(message.token_id);
      }
    ...
    static decode(reader: Reader, length: i32): is_claimed_arguments {
      const end: usize = length < 0 ? reader.end : reader.ptr + length;
      const message = new is_claimed_arguments();
  ...
  export class claim_tokens_arguments {
    static encode(message: claim_tokens_arguments, writer: Writer): void {
      if (message.token_id.length != 0) {
        writer.uint32(10);
        writer.bytes(message.token_id);
      }
    ...
    static decode(reader: Reader, length: i32): claim_tokens_arguments {
      const end: usize = length < 0 ? reader.end : reader.ptr + length;
      const message = new claim_tokens_arguments();
  ...
  export class claim_event {
    static encode(message: claim_event, writer: Writer): void {
      if (message.from.length != 0) {
        writer.uint32(10);
        writer.bytes(message.from);
      }
    ...
    static decode(reader: Reader, length: i32): claim_event {
      const end: usize = length < 0 ? reader.end : reader.ptr + length;
      const message = new claim_event();
